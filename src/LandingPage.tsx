...
const LandingPage: React.FC = () => {
  return (
    <Container>
      ...
      <HeroSection>
        <WelcomeText>
          <h1>Engineered for Hiring Efficiency.</h1>
          <p>Connecting top talent with leading employers.</p>
      ...
      <AdditionalContent>
        ...
        <h2>Join Us Today!</h2>
        <p>
          Ready to take the next step in your career? Join Q-Squared today and
          experience a new standard in recruitment. Whether you are a candidate
          looking for your dream job or an employer seeking exceptional talent,
